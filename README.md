...
This project is built purely using front-end technologies with no backend dependencies:
* **HTML5** – Semantic structure and layout markup.
* **CSS3** – Advanced styling, Flexbox grids, media queries, and custom animations.
* **Vanilla JavaScript** – Light script utilities for interactive element triggers and navigation handling.
...
Art-main/
│
├── CSS/                  # Stylesheets for individual pages (Contact, About, Gallery, etc.)
├── Content/              # Images, artwork items, icons, and logos
├── HTML/                 # Secondary pages (About, Contactform, Terms, Privacy, etc.)
├── javascript/           # Front-end interactive scripts
